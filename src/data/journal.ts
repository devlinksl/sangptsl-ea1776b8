...
export const articles: Article[] = [
  ...
  {
    slug: "ai-and-education-in-sierra-leone",
    title: "AI & Education: Transforming Learning in Sierra Leone",
    excerpt:
      "How Sangpt is helping students across Sierra Leone study smarter, research faster, and prepare for a technology-driven future.",
    category: "Behind Sangpt",
    date: "February 25, 2026",
    readTime: "8 min read",
    image: blog7,
    content: [
      "Education is the foundation of progress in Sierra Leone. At Dev-Link, we believe AI can play a transformative role in how Sierra Leonean students learn, study, and prepare for the future.",
      "Sangpt is already being used by students at Fourah Bay College, IPAM, Njala University, and schools across Freetown to enhance their academic work. From summarizing research papers to helping draft essays, Sangpt is becoming an essential study companion.",
      "But we're careful about how AI is used in education. We've designed Sangpt to be a learning aid, not a shortcut. The AI encourages critical thinking by explaining its reasoning, providing multiple perspectives, and asking follow-up questions.",
      "We've also partnered with educators to develop subject-specific plugins that align with Sierra Leone's curriculum. These plugins provide structured learning experiences in mathematics, science, English, and more.",
      "The response from students has been incredible. One university student told us: 'Sangpt helps me understand complex topics in a way my textbooks can't. It's like having a tutor available 24/7.'",
      "Looking ahead, we're exploring partnerships with the Ministry of Education to bring AI-assisted learning to more schools across Sierra Leone. The future of education in Salone is bright, and Sangpt is proud to be part of it.",
      "If you're a student, teacher, or education administrator in Sierra Leone, we'd love to hear from you. Together, we can build a smarter future for our country.",
    ],
  },
];
