          ...
          <motion.div {...fadeUp(0.1)} className="glass-hover rounded-2xl p-1 min-h-[320px] flex items-center justify-center">
            <div className="w-full h-full rounded-xl bg-secondary/50 flex items-center justify-center">
              <div className="text-center">
                <div className="w-20 h-20 rounded-2xl bg-secondary border border-border flex items-center justify-center mx-auto mb-4">
                  <Lightbulb className="h-10 w-10 text-foreground/40" />
                </div>
          ...
          <div className="flex flex-col gap-5">
            <motion.div {...fadeUp(0.15)} className="glass-hover rounded-2xl p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-display font-semibold text-lg mb-2 text-foreground">Our Mission</h3>
            ...
            <motion.div {...fadeUp(0.2)} className="glass-hover rounded-2xl p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-display font-semibold text-lg mb-2 text-foreground">Community Driven</h3>
                  <p className="text-muted-foreground text-sm leading-relaxed">
            ...
            <motion.div {...fadeUp(0.25)} className="glass-hover rounded-2xl p-6">
              ...
              <p className="text-xs text-foreground mt-3 font-semibold">— Dev-Link Team</p>
            </motion.div>
          </div>
        </div>
      </div>
