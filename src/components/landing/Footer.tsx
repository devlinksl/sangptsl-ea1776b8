...
export function Footer() {
  ...
  return (
    <footer id="contact" className="glass-strong border-t border-border py-12">
        ...
        <div className="grid md:grid-cols-3 gap-10">
          ...
          <div>
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="font-display text-lg font-bold">San<span className="gradient-text">gpt</span></span>
            </div>
          ...
          {/* Newsletter */}
          <div>
            <h4 className="font-display font-semibold mb-4 text-sm">Stay Updated</h4>
            <p className="text-sm text-muted-foreground mb-3">Get the latest news and updates from Sangpt.</p>
            <div className="flex gap-2">
              <input
                type="email"
                placeholder="your@email.com"
                className="flex-1 px-4 py-2.5 rounded-xl bg-secondary/50 border border-border text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-primary"
              />
